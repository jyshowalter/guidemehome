...
switch (e.which) {
case 37:
GFSlider.noUiSlider.set(sliderValue - step);
break;
case 39:
GFSlider.noUiSlider.set(sliderValue + step);
break;
...
var tt = GFSlider.querySelector('.noUi-tooltip')
var handleText = handle.getAttribute('aria-valuetext')

GFSlider.noUiSlider.on('update', function(sliderVal) {
if (sliderVal == max) {
handle.setAttribute('aria-valuetext', handleText + '+');
